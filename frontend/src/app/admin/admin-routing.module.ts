...
import { AdminAnnouncementListComponent } from './announcement/list/admin-announcement-list/admin-announcement-list.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      AdminAnnouncementListComponent.Route
    ]
  }
];
